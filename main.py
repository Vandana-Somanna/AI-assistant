...
async def chat_api(request: Request):
    try:
        ...
        result = agent_chat(message, session_id=session_id)
        ...
        # logger.info(f"RETRIEVED CONTEXT: {answer}")
        # logger.info(f"TOOL USAGE: Agent processed tools for query: {agent_chat.used_tools}")  # Log which tools were used in this query
