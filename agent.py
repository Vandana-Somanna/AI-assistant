...
RAG_PROMPT = ChatPromptTemplate.from_messages([
    ("system", "You are a support assistant. Answer ONLY from the provided CONTEXT. If not present, say: 'I don't know based on our docs.' and confirm the information before you create any ticket"),
    ("human", "QUESTION:\n{question}\n\nCONTEXT:\n{context}")
])
...
def chat(message: str, session_id: str = "default") -> str:
    ...
    if intents["order_status"] and order_id:
        ...
        used_tools.append("check_order_status")
        if info.get("found"):
            parts.append(
